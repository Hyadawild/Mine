...
import AnimeSection from "../components/Home/WhereIHaveWorked/Anime/AnimeSection"
...
export default function Home() {
  ...
  const meta = {
    title: "HyadaYada - Software Developer",
    ...
    <>
      ...
      {!isBlackListed ? (
        <div className="relative snap-mandatory min-h-screen bg-AAprimary w-full ">
          ...
          {context.sharedState.finishedLoading ? <AnimeSection /> : <></>}
