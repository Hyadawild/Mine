...
export default function FeverTokens() {
  const tasks = [
    ...
    {
      text: "Collaborated with a team of six developers to build a temporary NFT Marketplace, utilizing Next.js, Ether.js, Tailwind CSS, AWS Lambda, and Hardhat.",
      keywords: [, "Next.js", "Ether.js", "Tailwind CSS", "AWS Lambda", "Hardhat"],
    },
    {
