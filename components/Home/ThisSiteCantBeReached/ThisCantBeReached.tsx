...
export default function ThisCantBeReached() {
  ...
  return (
    <motion.div
      ...
      className="absolute h-screen w-full bg-grey-900 
      py-16 sm:py-40 
      ...
      <div className="relative w-full  flex flex-col space-y-4">
        ...
        >
          ...
          <motion.div
            ...
            className=""
          >
            <div className="absolute right-3 top-0 h-1 w-1 bg-white"></div>
            <div className="absolute right-0 top-[10px] h-1 w-1 bg-rose-50"></div>
            <div className="absolute right-1 top-[7px] h-[4px] w-[4px]bg-rose-50"></div>
            <div className="absolute right-2 top-[4px] h-[4px] w-[4px] bg-rose-50"></div>
          </motion.div>

          {/* Smile */}

          <div className="absolute left-3 bottom-[10px] w-3 h-[3px] bg-rose-50"></div>
          <motion.div
            animate={{ y: [0, -5, 0, -5, 0, -5] }}
            transition={{ y: { delay: 3, duration: 0.5 } }}
            className="absolute left-[9px] bottom-[7px] w-[3px] h-[3px] bg-white"
          ></motion.div>
          <motion.div
            animate={{
              y: [0, -5, 0, -5, 0, -5, 0, -5],
            ...
            transition={{ y: { delay: 3, duration: 0.5 } }}
            className="absolute right-[9px] bottom-[7px] w-[3px] h-[3px] bg-white"
          ></motion.div>
        ...
        >
          ...
          <span className="text-gray-500 text-md">
            <span className="font-bold">www.hyadayada.com </span>
            unexpectedly{" "}
            {ShowText ? (
              <motion.span
