        ...
        <div className="w-full flex flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-8 sm:space-x-2">
          ...
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm">
            <div className="font-Header text-gray-400 text-justify">
              Hey there! I&apos;m Haydar Wildan Zacky, and I&apos;m pretty
              obsessed with building cool stuff with code. My tech journey
              started when I was just 14 years old – I got my hands on Cheating
              game and was instantly hooked. That curiosity led me down a rabbit
              hole of programming that I&apos;m still happily stuck in today.
            </div>
            <div className="font-Header text-gray-400 text-justify">
              After years of teaching myself and eventually Studying my{" "}
              <span className="text-AAsecondary">engineering degree</span> and{" "}
              <span className="text-AAsecondary"></span>, I&apos;ve spent{" "}
              ...
              <span className="text-AAsecondary">
                Squiz Matrix CMS, Auto Classing for IL2CPP
              </span>
              .
            </div>
            <div className="font-Header text-gray-400 text-justify">
