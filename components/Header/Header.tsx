    ...
    <>
      ...
      <motion.div
        ...
        className={`w-full fixed ${
          ShowElement
            ? `bg-opacity-90 shadow-lg backdrop-blur-md border-b border-animePrimary/20`
            : `bg-opacity-0`
        } bg-AAprimary flex justify-between px-6 sm:px-12 py-2 sm:py-4 transition-all duration-300 translate-y-0 z-20`}
      >
        {/* Logo A */}
